...
# run
t_cvode=system.time({
sol_cvode<- cvode(seq(0,100,0.2), u0+1e-10, f_sundials,0,reltolerance = 1e-4,abstolerance = 1e-4)
})
...
t_cvode_cpp=system.time({
  sol_cvode_cpp<- cvode(seq(0,100,0.2), u0+1e-10, f_sundials_Rcpp, NaN,reltolerance = 1e-4,abstolerance = 1e-4)
})
